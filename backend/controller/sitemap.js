...
exports.generateMainSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'dist', 'sitemap-main.xml');
...
exports.generateProductSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'dist', 'sitemap-product.xml');
...
exports.generateServiceSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'dist', 'sitemap-service.xml');
...
exports.generateNewsSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath =  path.join(__dirname, '..', 'dist', 'sitemap-blog.xml');
...
exports.generateSitemapIndex = async (req, res) => {
  try {
    const sitemaps = [
      { url: 'https://apurvachemicals.com/sitemap-main.xml' },
      { url: 'https://apurvachemicals.com/sitemap-product.xml' },
      { url: 'https://apurvachemicals.com/sitemap-blog.xml' },
    ];
