  ...
  return (
    <div className="mt-12 bg-gradient-to-r from-gray-100 to-gray-100 p-5 shadow-md">
      ...
      <div className="flex gap-4 mb-3">
        ...
        <button 
          className="flex items-center px-4 py-2 text-black bg-white hover:text-white shadow-md hover:bg-red-700 over:border-black transition-colors duration-200"
