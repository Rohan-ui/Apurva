...
const EditPageContent = () => {
  ...
  const fetchPageContent = async () => {
    try {
      const response = await axios.get(`/api/aboutus/getAboutus`, { withCredentials: true });
      ...
      setSubheading(aboutus.subheading);
      setVideoUrl(aboutus.video || "");
    } catch (error) {
      console.error(error);
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4">
      ...
      <div className="mb-4">
        <label htmlFor="videoUrl" className="block font-semibold mb-2">
          Video URL
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label className="block font-semibold mb-2">Upload New Photos</label>
